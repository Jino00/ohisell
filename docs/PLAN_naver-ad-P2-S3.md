...
- [x] ✅ `bid_simulator.py` (pooled_rpc·affordable_ceiling[division guard]·simulate_bid[device 가정 라벨·capability]) + 단위테스트
...
- [x] ✅ `proposal_pipeline.py` (freshness 게이트·as_of·precompute·단계상태·만료) + 통합테스트
