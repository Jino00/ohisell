...
- **D-14 (M3 로켓1P 우리자료 vs 쿠팡 실제 라인 대조 + leaf 배선 — 2026-08-05, Jino 지시 "로켓배송
  ...
  **결론: "값은 틀린 적이 없다. 틀린 건 완결성과 귀속이다."**
  ...
  - **A'축(계산서↔발주 브리지)**: 294덩어리 중 286(97.3%) ±1원 일치. 불일치 8건 중 7건은
    「월말 역발행 차감」(합 −4,321,823원, PO가 없는 게 정상 구조 — 발주와 무관한 차감. 내역은 화면에
    없어 **쿠팡 문의 필요**), 1건은 2025-08-19~09-12 구간 −459,000원 **미해명**.
  ...
  - **미해결 (Jino/외부 몫)**: ①**C축 원가 자동매핑** — 30일 GMV의 **31.74%가 다른 물건의 원가**를
    ...
    **교훈 #117 금지선**(이름 유사도 자동 매핑 재발 금지) — 모델이 직접 고치지 않고 의심 21건
    목록만 전달. ②역발행 차감 7건 −4,321,823원 내역 미상 → 쿠팡 문의. ③2025-08-19~09-12
    구간 −459,000원 미해명. ④**합격기준 ①**(오픽스 RG 매출 −17,342,298원 배선)은 이 세션
...
- ✅ **M3 완료 — 로켓1P 원장 대조 + leaf 배선(2026-08-05, D-14)**. Jino 지시로 착수한 "우리 자료 vs
  ...
  일치**, 불일치는 대부분 역발행 차감(정상 구조, 내역은 쿠팡 문의). **B축(판매분석) 페이지네이션 유실**을
  ...
  Jino 몫)**·역발행 차감 내역(외부 문의)·2025-08 구간 −459,000원 미해명·오픽스 RG 매출 배선(합격기준①)
  미착수·PR 미생성·codex 미실행(08-09 리셋 후).
