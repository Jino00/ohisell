...
- [ ] 비-0 검증: 「90일」(05-31~08-28) PAO = 522,960원/1일/57그룹 = 전부 2026-07-29(캠페인 통째 관할 실사례)
- [ ] 반증: PAO 밴드에 2,170,514원 또는 7,607,618원이 나오면 미달
- [ ] 「90일」 조회: 2026-07-11 이전이 「모름」 26,078,407원(45.1%)으로 분리 표기
- [ ] 기록 모순 4건(8492582 3건 · 0907625 1건)이 세어지고 그 앞이 모름으로 밀리며 화면이 말한다
- [ ] 적재가 뒤처지면 「확정 데이터만 셉니다」 문장이 뜬다(2R P2 — 사라졌던 자리)
