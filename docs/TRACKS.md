...
## 🟢 Active
- [쿠팡 매출·광고 정합성](tracks/active/track_coupang-revenue-ad-reconciliation.md) — **6/7**. 종합조망 매출·광고·순이익을 쿠팡 대시보드와 일치 + 계정별 분리. **S1~S4·S6·S7 완료·prod 배포·라이브 검증**(2026-06-14: 계정분리·2중계상수정·RG매출편입[52%갭해소]·net_profit D-3·신선도 reconcile+이중차감수정 D-12·검산 대시보드 프론트). RG 신선도는 라이브 진단상 gross 불변 피드로 reconcile 불가→문서화 종료(D-11). **다음=S5 광고 전수 자동화(유일 잔여, 공식 API 없음·의사결정 필요).**
