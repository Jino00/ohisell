...
## 🟢 Active
- [쿠팡 매출·광고 정합성](tracks/active/track_coupang-revenue-ad-reconciliation.md) — 0/7. 종합조망 매출·광고·순이익을 쿠팡 대시보드와 일치 + 계정별(오픽스/오하이테크) 분리. 라이브 진단 완료(2026-06-14: 광고 0.02% 일치, 매출 RG 누락 52%, RG 매출은 CoupangRgOrderItem에 기수집). 다음=S1 계정 분리 뷰.
