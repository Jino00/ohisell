...
왜냐하면 **진행률 N/M은 «마일스톤을 몇 개 닫았나»만 재지 «궁극 목표에 닿았나»를 못 재기 때문이다.** 실측(2026-08-22): M0·M1을 닫아 2/7인데, 궁극 목표 5요소 중 **④자동화 운영·⑤상시 개선은 착수 0**이고 제안 기반 실집행은 07-30 이후 **0건**이다. 그 30일 동안 광고비 4,220만원은 전부 대행사가 집행했다. 아홉 세션 연속 D-NAO-59 미달이 이 간극의 기록이다 — **N/M만 보면 「순조롭다」로 읽힌다.**
