...
### ★원가 매핑 사고 (반드시 읽을 것)
- 어제 "형제 확정 매핑이 만든 규칙을 따랐다"며 5건을 확정했으나, 그 선례들이 전부 `match_method='suggested'` + `note='auto score=0.56~0.78'` — **2026-06-17 23:25~23:31 6분 배치의 이름 유사도 자동 결과**였다. 자동 결과를 사람의 판단으로 오독하고 그 위에 쌓았다(LESSONS #118).
