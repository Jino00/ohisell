...
- ~~★미해결 질문(2026-06-07, 새 주제): 오하이테크 로켓배송 상품(8314657485)을 오픽스 윙/로켓그로스로 복사 등록~~ → **CLOSE (2026-06-07, Jino 결정 "여기서 하지 말자").** 추진 안 함. 다시 꺼내지 말 것. (참고: ohisell엔 상품등록 쓰기기능 없음 / 쿠팡 계정간 복사 공식지원 여부 미확인.)
