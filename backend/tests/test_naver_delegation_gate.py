...
def test_delegable_types_is_negative_keyword_only_x1a():
    """X1a T5 시점: OPEN_ACTIONS={'add_negative_keyword'}뿐이라 delegable도 그것뿐."""
    assert delegation_gate.delegable_types() == {"negative_keyword"}
