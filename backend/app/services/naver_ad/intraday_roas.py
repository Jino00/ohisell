...
③ 보정계수 불필요: unit_price는 네이버 convAmt(2.6× 과대 계상, D-NAO-7)가 아니라 실 주문
   판매가(NaverProductBep.selling_price, 실거래 매출 가중)에서 나온다 — 이미 더 정직한
   매출 신호이므로 D-NAO-7류 correction_factor를 여기 곱하지 말 것.
